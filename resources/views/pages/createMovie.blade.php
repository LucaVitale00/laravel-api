...
@section('content')
    ...
    <div class="container my-5 bg-dark py-5 rounded-5">

        <h1 class="text-danger text-center">Create New Movie</h1>
        ...
        <form method="POST" action="{{route('store.movie')}}" class="p-3">
            ...
            <select name="genre_id" class="form-select form-select-sm my-2" aria-label=".form-select-sm example">
